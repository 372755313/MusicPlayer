...
- (void)hideInController
{
    if ([self isShowInAlertController]) {
        ...
        DLog(@"self.viewController is nil, or isn't TYAlertController");
    }
}
...
- (void)hideView
{
    if ([self isShowInAlertController]) {
        ...
        DLog(@"self.viewController is nil, or isn't TYAlertController,or self.superview is nil, or isn't TYShowAlertView");
    }
}
