...
{
    FDAlertView *fdV = [[FDAlertView alloc] initWithTitle:title icon:nil message:message delegate:nil buttonTitles:cancelButtonTitle,otherButtonTitles, nil];
    [fdV setButtonTitleColor:[UIColor lightGrayColor] font:[UIFont systemFontOfSize:14] atIndex:0];
    [fdV setButtonTitleColor:HWColor(20, 120, 241) font:[UIFont boldSystemFontOfSize:14] atIndex:1];
